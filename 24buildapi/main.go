...
func main() {
	...
	//seeding
	courses = append(courses, Course{CourseID: "2", CourseName: "ReactJs", CoursePrice: 299, Author: &Author{Fullname: "Nishant", Website: "lco.dev"}})
	courses = append(courses, Course{CourseID: "4", CourseName: "MernStack", CoursePrice: 199, Author: &Author{Fullname: "Nishant", Website: " go.dev"}})
...
func getOneCourse(w http.ResponseWriter, r *http.Request) {
	...
	// loop through the courses, finding the matching id and return the response
